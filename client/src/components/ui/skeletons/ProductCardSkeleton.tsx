...
const ProductCardSkeleton: React.FC<ProductCardSkeletonProps> = ({ layout }) => {
  if (layout === 'table') {
    return (
      <div className="flex animate-pulse items-center gap-4 rounded-md  p-1.5">
  ...
  // Grid skeleton
  return (
    <div className="animate-pulse rounded-md ring-1 ring-neutral">
      <div className="rounded-t-md mb-3 h-56 w-full bg-gray-300/60" />
