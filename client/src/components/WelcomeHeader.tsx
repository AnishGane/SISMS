...
const WelcomeHeader = ({ text, subText, avatarUrl }: WelcomeHeaderProps) => {
  ...
  return (
    <div className="flex w-full items-center justify-between rounded-md bg-neutral-100/80 p-4 shadow-sm">
      ...
      <div className="flex items-center justify-center gap-3">
        ...
        <div className="flex size-10 items-center justify-center overflow-hidden rounded-full bg-white ring-2 ring-gray-800">
          {avatarUrl ? (
